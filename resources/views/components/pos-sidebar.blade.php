<div class="flex lg:h-screen ">
   <div class="flex flex-row w-auto shrink-0 pl-4 pr-2 py-4">
      <div class="flex flex-col items-center py-4 shrink-0 w-20 bg-cyan-500 rounded-3xl">
        <a href="#"
        ...
        <ul class="flex flex-col space-y-2 my-auto">
          <li>
            <a href="{{route('counter.index')}}"
               class="flex items-center">
              <span
                class="flex items-center justify-center h-12 w-12 rounded-2xl hover:bg-cyan-200 {{ request()->is('counter.index') ? 'hover:bg-cyan-400 text-cyan-100' : 'bg-cyan-300 shadow-lg text-white' }} "
                x-bind:class="{
          ...
          <li>
            <a href="#"
               class="flex items-center">
              <span class="flex items-center justify-center text-cyan-100 hover:bg-cyan-400 h-12 w-12 rounded-2xl activeMenu">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
